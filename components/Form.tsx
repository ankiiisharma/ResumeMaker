    ...
    return (
        <div className="relative flex items-center justify-center min-h-screen">
            ...
            <div className="relative w-full max-w-md p-8 space-y-8 bg-gray-800/80 rounded-md border border-slate-50/20 shadow-sm">
                <h2 className="text-3xl tracking-[-2px] font-bold text-center text-white">fill the information below!</h2>
                <div className={`transition-all duration-200 transform ${
                    ...
                    <form onSubmit={(e) => e.preventDefault()} className="space-y-6">
                        ...
                        <div className="flex gap-4">
                            ...
                            <Button 
                                onClick={handleNext} 
                                className={`flex justify-center items-center ${currentField === 0 ? 'w-full' : 'flex-1'}`}
                            >
